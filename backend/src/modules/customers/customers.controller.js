...
const list       = async(req,res,next)=>{ try{return successResponse(res,await svc.findAll({page:+req.query.page||1,pageSize:+req.query.pageSize||20,keyword:req.query.keyword||''}),'查询成功')}catch(e){next(e)} }
...
const credit     = async(req,res,next)=>{ try{return successResponse(res,await svc.getCustomerCredit(+req.params.id),'查询成功')}catch(e){next(e)} }
module.exports = { list, listActive, detail, create, update, remove, credit }

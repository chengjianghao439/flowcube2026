...
const list       = async (req, res, next) => { try { return successResponse(res, await svc.findAll({ page: parseInt(req.query.page)||1, pageSize: parseInt(req.query.pageSize)||20, keyword: req.query.keyword||'' }), '查询成功') } catch(e){next(e)} }

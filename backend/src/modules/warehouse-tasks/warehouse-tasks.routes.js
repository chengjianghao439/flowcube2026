...
router.put('/:id/start-picking', requirePermission(PERMISSIONS.WAREHOUSE_TASK_PICK), pdaOnly, pdaSessionOptional(), async (req, res, next) => {
...
router.put('/:id/ready', requirePermission(PERMISSIONS.WAREHOUSE_TASK_CHECK), pdaOnly, pdaSessionOptional(), async (req, res, next) => {
  try {
...
router.put('/:id/sort-done', requirePermission(PERMISSIONS.WAREHOUSE_TASK_SORT), pdaOnly, pdaSessionOptional(), async (req, res, next) => {
  try {
...
router.put('/:id/check-done', requirePermission(PERMISSIONS.WAREHOUSE_TASK_CHECK_DONE), pdaOnly, pdaSessionOptional(), async (req, res, next) => {
...
router.put('/:id/pack-done', requirePermission(PERMISSIONS.WAREHOUSE_TASK_PACK_DONE), pdaOnly, pdaSessionOptional(), async (req, res, next) => {
  try {
...
router.put('/:id/ship', requirePermission(PERMISSIONS.WAREHOUSE_TASK_SHIP), pdaOnly, pdaSessionOptional(), async (req, res, next) => {
  try {

...
const WT_EVENT = Object.freeze({
  ...
  CANCEL_RETURN_SCAN:     'CANCEL_RETURN_SCAN',
  CANCEL_RETURN_BOX_SCAN: 'CANCEL_RETURN_BOX_SCAN',
  CANCEL_FINALIZED:       'CANCEL_FINALIZED',
  ADJUSTMENT_REQUESTED:   'ADJUSTMENT_REQUESTED',
  ADJUSTMENT_REOPENED:    'ADJUSTMENT_REOPENED',
  ADJUSTMENT_RETURN_SCAN: 'ADJUSTMENT_RETURN_SCAN',
  ADJUSTMENT_VOID_SCAN:   'ADJUSTMENT_VOID_SCAN',
  ADJUSTMENT_FINALIZED:   'ADJUSTMENT_FINALIZED',
})

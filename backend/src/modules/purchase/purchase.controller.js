...
const confirm= async(req,res,next)=>{ try{await svc.confirm(+req.params.id,getOperatorFromRequest(req),req.user?.warehouseIds??null);return successResponse(res,null,'提交成功')}catch(e){next(e)} }

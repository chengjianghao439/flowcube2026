...
router.put('/:id',           requirePermission(PERMISSIONS.TRANSFER_ORDER_CREATE), vParams(idParam),vBody(createSchema),ctrl.update)
router.post('/:id/confirm',  requirePermission(PERMISSIONS.TRANSFER_ORDER_CONFIRM), vParams(idParam),ctrl.confirm)
router.post('/:id/scan-out', requirePermission(PERMISSIONS.TRANSFER_ORDER_EXECUTE), pdaSessionRequired(), pdaOnly, vParams(idParam),vBody(scanOutSchema),ctrl.scanOut)
router.post('/:id/scan-in',  requirePermission(PERMISSIONS.TRANSFER_ORDER_EXECUTE), pdaSessionRequired(), pdaOnly, vParams(idParam),vBody(scanInSchema),ctrl.scanIn)

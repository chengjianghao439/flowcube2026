...
async function buildNotifications() {
  ...
  if (unpaidReceivable > 0) pushNotification(items, seen, { code: 'UNPAID_RECEIVABLE', category: 'finance', priority: 12, type: 'danger', icon: '💰', text: `${unpaidReceivable} 笔应收账款未清`, path: '/payments/receivable' })

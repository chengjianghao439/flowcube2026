...
router.post('/:id/items/:itemId/scan', requirePermission(PERMISSIONS.STOCKCHECK_UPDATE), pdaOnly, pdaSessionRequired(), validateBody(scanSchema), ctrl.saveItemScans)

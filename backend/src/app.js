...
app.use('/api/customer-addresses', require('./modules/customer-addresses/customer-addresses.routes'))
...
app.use('/api/purchase-requisitions', require('./modules/purchase-requisitions/purchase-requisitions.routes'))
...
app.use('/api/refunds',    require('./modules/refunds/refund-orders.routes'))
app.use('/api/credit-overrides', require('./modules/credit-overrides/credit-overrides.routes'))
...
app.use('/api/return-tasks', require('./modules/return-tasks/return-tasks.routes'))
...
app.use('/api/document-activity', require('./modules/document-activity/document-activity.routes'))
...
app.use('/api/price-change',   require('./modules/price-change/price-change.routes'))
...
app.use('/api/plastic-boxes', require('./modules/plastic-boxes/plastic-boxes.routes'))
...
app.use('/api/pda-devices',    require('./modules/pda-devices/pda-devices.routes'))

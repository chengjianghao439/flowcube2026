...
上面的验证与已知边界记录的是 2026-09-17 版本。i6310pro 真机确认无焦点硬件扫码可用后，收货上架页按用户反馈单独改为「默认硬件扫码，点下方扫码区域才弹出手输键盘」。其它 `PdaScanner` 页面仍用原有按钮或强制扫码；不增加自动聚焦。现行约定与真机验收边界见 `docs/frontend-pda-conventions.md`、`docs/pda-scanner-broadcast-2026-09-23.md`。

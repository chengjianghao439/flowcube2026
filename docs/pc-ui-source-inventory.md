...
本次源码扫描：226 个候选 TSX 文件；163 个弹层/CRUD/覆盖层节点；路由注册表 83 个静态或动态定义。节点数量不等于独立弹窗数量，共用及条件实例可能重复。
...
| '/procurement' | '采购计划' | ProcurementPlanListPage |
...
| '/reports/profit-analysis' | '利润 / 库存分析' | ProfitAnalysisPage |
| '/reports/avg-cost-reconciliation' | '成本对账' | AvgCostReconciliationPage |
| '/reports/kpi' | '经营 KPI' | KpiPage |
| '/reports/replenishment' | '补货建议' | ReplenishmentPage |
| '/reports/inventory-aging' | '存放时长与滞销' | InventoryAgingPage |
| '/reports/warehouse-ops' | '仓库运营看板' | WarehouseOpsPage |
| '/reports/wave-performance' | '批次效率' | WavePerformancePage |
| '/reports/pda-anomaly' | 'PDA 异常分析' | PdaAnomalyPage |
| '/reports/role-workbench' | '岗位工作台' | RoleWorkbenchPage |
...
| [components/dashboard/widgets/RiskDetails.tsx](../frontend/src/components/dashboard/widgets/RiskDetails.tsx) | DialogContent:55 |
...
| [components/shared/BaseCrudPage.tsx](../frontend/src/components/shared/BaseCrudPage.tsx) | DialogContent:168；ConfirmDialog:185 |
...
| [components/shared/ContainerDrawer.tsx](../frontend/src/components/shared/ContainerDrawer.tsx) | SheetContent:40 |
...
| [components/shared/Pagination.tsx](../frontend/src/components/shared/Pagination.tsx) | — |
| [components/shared/PaginationArrow.tsx](../frontend/src/components/shared/PaginationArrow.tsx) | — |
...
| [components/shared/ProductFinderModal.tsx](../frontend/src/components/shared/ProductFinderModal.tsx) | AppDialog:65 |
...
| [pages/accounting/consolidation/index.tsx](../frontend/src/pages/accounting/consolidation/index.tsx) | DialogContent:149 |
| [pages/accounting/invoices/index.tsx](../frontend/src/pages/accounting/invoices/index.tsx) | DialogContent:71；ConfirmDialog:182 |
| [pages/accounting/ledger/index.tsx](../frontend/src/pages/accounting/ledger/index.tsx) | DialogContent:26 |
| [pages/accounting/periods/index.tsx](../frontend/src/pages/accounting/periods/index.tsx) | DialogContent:131；DialogContent:146 |
...
| [pages/accounting/vouchers/index.tsx](../frontend/src/pages/accounting/vouchers/index.tsx) | DialogContent:93；DialogContent:125；DialogContent:211；ConfirmDialog:425；ConfirmDialog:434 |
...
| [pages/credit-overrides/index.tsx](../frontend/src/pages/credit-overrides/index.tsx) | DialogContent:53；DialogContent:258 |
...
| [pages/customers/index.tsx](../frontend/src/pages/customers/index.tsx) | ConfirmDialog:151；DialogContent:163 |
...
| [pages/disposal/components/CreateDisposalDialog.tsx](../frontend/src/pages/disposal/components/CreateDisposalDialog.tsx) | DialogContent:99 |
| [pages/disposal/components/DisposalDetailDialog.tsx](../frontend/src/pages/disposal/components/DisposalDetailDialog.tsx) | DialogContent:53；DialogContent:145 |
...
| [pages/finance/expenses/index.tsx](../frontend/src/pages/finance/expenses/index.tsx) | DialogContent:58；DialogContent:294；DialogContent:359；DialogContent:403；DialogContent:445 |
| [pages/finance/transactions/index.tsx](../frontend/src/pages/finance/transactions/index.tsx) | DialogContent:52 |
| [pages/fixed-assets/index.tsx](../frontend/src/pages/fixed-assets/index.tsx) | DialogContent:42；DialogContent:108 |
...
| [pages/inbound-tasks/detail.tsx](../frontend/src/pages/inbound-tasks/detail.tsx) | ConfirmDialog:272；ConfirmDialog:293；ConfirmDialog:323 |
| [pages/inbound-tasks/index.tsx](../frontend/src/pages/inbound-tasks/index.tsx) | ConfirmDialog:436 |
...
| [pages/inventory/index.tsx](../frontend/src/pages/inventory/index.tsx) | DialogContent:361；DialogContent:389 |
...
| [pages/locations/index.tsx](../frontend/src/pages/locations/index.tsx) | BaseCrudPage:135 |
...
| [pages/logistics/detail.tsx](../frontend/src/pages/logistics/detail.tsx) | DialogContent:146 |
...
| [pages/oplogs/index.tsx](../frontend/src/pages/oplogs/index.tsx) | ConfirmDialog:180；DialogContent:190 |
...
| [pages/picking-waves/index.tsx](../frontend/src/pages/picking-waves/index.tsx) | DialogContent:276 |
...
| [pages/price-change/index.tsx](../frontend/src/pages/price-change/index.tsx) | DialogContent:173；DialogContent:216；ConfirmDialog:229 |
...
| [pages/products/index.tsx](../frontend/src/pages/products/index.tsx) | DialogContent:216；ConfirmDialog:251 |
...
| [pages/purchase-requisitions/form.tsx](../frontend/src/pages/purchase-requisitions/form.tsx) | DialogContent:376；DialogContent:391 |
...
| [pages/purchase/form/index.tsx](../frontend/src/pages/purchase/form/index.tsx) | ConfirmDialog:755；DialogContent:771 |
| [pages/purchase/index.tsx](../frontend/src/pages/purchase/index.tsx) | ConfirmDialog:368；DialogContent:388 |
| [pages/racks/RackQueryDialog.tsx](../frontend/src/pages/racks/RackQueryDialog.tsx) | AppDialog:37 |
| [pages/racks/index.tsx](../frontend/src/pages/racks/index.tsx) | BaseCrudPage:146 |
| [pages/refunds/RefundQueryDialog.tsx](../frontend/src/pages/refunds/RefundQueryDialog.tsx) | AppDialog:39 |
| [pages/refunds/components/RefundDetailDialog.tsx](../frontend/src/pages/refunds/components/RefundDetailDialog.tsx) | DialogContent:50 |
| [pages/refunds/index.tsx](../frontend/src/pages/refunds/index.tsx) | DialogContent:184 |
...
| [pages/reports/replenishment.tsx](../frontend/src/pages/reports/replenishment.tsx) | DialogContent:241 |
...
| [pages/returns/index.tsx](../frontend/src/pages/returns/index.tsx) | ConfirmDialog:286 |
...
| [pages/sale/components/ReleaseAllocationDialog.tsx](../frontend/src/pages/sale/components/ReleaseAllocationDialog.tsx) | DialogContent:69 |
| [pages/sale/components/ReserveAllocationDialog.tsx](../frontend/src/pages/sale/components/ReserveAllocationDialog.tsx) | DialogContent:120 |
| [pages/sale/components/SaleOrderPreview.tsx](../frontend/src/pages/sale/components/SaleOrderPreview.tsx) | Dialog.Content:48 |
| [pages/sale/components/SaleRowActions.tsx](../frontend/src/pages/sale/components/SaleRowActions.tsx) | — |
| [pages/sale/components/ShipSelectDialog.tsx](../frontend/src/pages/sale/components/ShipSelectDialog.tsx) | DialogContent:49 |
...
| [pages/sale/form/index.tsx](../frontend/src/pages/sale/form/index.tsx) | ConfirmDialog:998 |
| [pages/sale/index.tsx](../frontend/src/pages/sale/index.tsx) | ConfirmDialog:277 |
...
| [pages/settings/pda-devices/index.tsx](../frontend/src/pages/settings/pda-devices/index.tsx) | DialogContent:179；DialogContent:225；DialogContent:266；ConfirmDialog:313 |
...
| [pages/stockcheck/components/CheckDetailDialog.tsx](../frontend/src/pages/stockcheck/components/CheckDetailDialog.tsx) | DialogContent:154；ConfirmDialog:254；ConfirmDialog:263 |
| [pages/stockcheck/index.tsx](../frontend/src/pages/stockcheck/index.tsx) | DialogContent:86 |
...
| [pages/transfer/form/index.tsx](../frontend/src/pages/transfer/form/index.tsx) | ConfirmDialog:471 |
| [pages/transfer/index.tsx](../frontend/src/pages/transfer/index.tsx) | ConfirmDialog:260；AppDialog:270 |
...
| [pages/users/index.tsx](../frontend/src/pages/users/index.tsx) | ConfirmDialog:189 |

          ...
          */}
          <Route path="/pda" element={<PdaProtectedRoute />}>
            <Route element={<PdaLayout />}>
              ...
              <Route path="stockcheck/:id" element={<PdaRoutePermission title="序列号盘点" required={[PERMISSIONS.STOCKCHECK_VIEW]}><PdaStockcheckPage /></PdaRoutePermission>} />
              <Route path="stockcheck" element={<PdaRoutePermission title="序列号盘点" required={[PERMISSIONS.STOCKCHECK_VIEW]}><PdaStockcheckPage /></PdaRoutePermission>} />

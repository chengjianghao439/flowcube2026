...
export interface CreateProductParams { name: string; categoryId?: number | null; unit?: string; spec?: string; barcode?: string; costPrice?: number | null; remark?: string }
export interface UpdateProductParams { name: string; categoryId?: number | null; unit?: string; spec?: string; barcode?: string; costPrice?: number | null; remark?: string; isActive: boolean }

...
const PATH_PERMS: Record<string, PermCode> = {
  ...
  '/settings/barcode-print-query': 'page:settings',
  '/oplogs':          'page:users',
  '/reports':         'page:reports',
  '/reports/role-workbench': 'page:reports',
  '/reports/exception-workbench': 'page:reports',
  '/reports/reconciliation': 'page:reports',
  '/reports/profit-analysis': 'page:reports',
  '/reports/approvals': 'page:reports',

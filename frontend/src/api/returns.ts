...
export const getPurchaseReturnSourceOrderApi = (orderNo:string) => client.get<ApiResponse<PurchaseReturnSourceOrder>>('/returns/purchase/source-order', { params:{ orderNo } })
...
export const getSaleReturnSourceOrderApi = (orderNo:string) => client.get<ApiResponse<SaleReturnSourceOrder>>('/returns/sale/source-order', { params:{ orderNo } })

...
export interface ReturnLinkedTask { id:number; taskNo:string; status:number; statusName:string }
...
export const createPurchaseReturnApi= (d:object) => client.post<{id:number; returnNo:string}>('/returns/purchase', d)
...
export const createSaleReturnApi     = (d:object) => client.post<{id:number; returnNo:string}>('/returns/sale', d)

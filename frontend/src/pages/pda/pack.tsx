...
export default function PdaPackPage() {
  ...
  const handleScan = useCallback((raw: string) => {
    ...
    if (parsed.type !== 'product' && parsed.type !== 'unknown') { err('请扫描产品条码（P000123 或 SKU 编码）'); return }
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <PdaBottomBar>
          {activePackageId && <PdaScanner onScan={handleScan} placeholder="扫描产品条码 P000123" disabled={addMut.isPending} />}

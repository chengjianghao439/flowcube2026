...
interface Props {
  ...
  resetValues?: Partial<ReturnQueryValues>
  onClose: () => void
  onApply: (values: ReturnQueryValues) => void
}

export default function ReturnQueryDialog({ open, type, initial, resetValues, onClose, onApply }: Props) {
  ...
  return (
    <>
      <AppDialog
        ...
        resizable={false}
        defaultWidth={type === 'sale' ? 680 : 520}
        defaultHeight={520}
        minWidth={420}
        minHeight={420}
        footer={
